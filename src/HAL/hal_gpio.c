...
static int32_t msp430fr69cc_gpio_p1_1_init_map_to_gpio_1(void)
{
...
static void msp430fr69cc_gpio_p1_1_deinit_map_to_gpio_1(void)
{
    return;
}

static int32_t msp430fr69cc_gpio_p1_1_read_pin_map_to_gpio_1(HAL_GPIO_PIN_STATE *res)
{
    int32_t ret = HAL_SUCCESS;
    int32_t pin_state = 0;

    pin_state = GPIO_getInputPinValue(GPIO_PORT_P1, GPIO_PIN1);
    if (pin_state > GPIO_INPUT_PIN_HIGH) {
        ret = HAL_ERR_UNSUPPORTED;
        goto finish;
    }
...
static void msp430fr69cc_gpio_p1_1_write_pin_map_to_gpio_1(HAL_GPIO_PIN_STATE value)
{
    if (HAL_GPIO_PIN_SET == value) {
...
static void msp430fr69cc_gpio_p1_1_toggle_pin_map_to_gpio_1(void)
{
    GPIO_toggleOutputOnPin(GPIO_PORT_P1, GPIO_PIN1);
}

static int32_t msp430fr69cc_gpio_p1_1_lock_pin_map_to_gpio_1(void)
{
    return HAL_ERR_UNSUPPORTED;
}
...
int32_t hal_gpio_init(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            break;
        case HAL_GPIO_1:
            ret = msp430fr69cc_gpio_p1_1_init_map_to_gpio_1();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
...
void hal_gpio_deinit(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            return;
        case HAL_GPIO_1:
            msp430fr69cc_gpio_p1_1_deinit_map_to_gpio_1();
            return;
#if LOCK_CODE
        case HAL_GPIO_2:
        case HAL_GPIO_3:
...
int32_t hal_gpio_read_pin(HAL_GPIO_CTX *gpio, HAL_GPIO_PIN_STATE *res)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            break;
        case HAL_GPIO_1:
            ret = msp430fr69cc_gpio_p1_1_read_pin_map_to_gpio_1(res);
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
...
int32_t hal_gpio_write_pin(HAL_GPIO_CTX *gpio, HAL_GPIO_PIN_STATE state)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            break;
        case HAL_GPIO_1:
            msp430fr69cc_gpio_p1_1_write_pin_map_to_gpio_1(state);
            break;
#if LOCK_CODE
        case HAL_GPIO_2:
        case HAL_GPIO_3:
...
int32_t hal_gpio_toggle_pin(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            break;
        case HAL_GPIO_1:
            msp430fr69cc_gpio_p1_1_toggle_pin_map_to_gpio_1();
            break;
#if LOCK_CODE
        case HAL_GPIO_2:
        case HAL_GPIO_3:
...
int32_t hal_gpio_lock_pin(HAL_GPIO_CTX *gpio)
{
    ...
    switch(gpio->hal_num) {
        case HAL_GPIO_0:
            ...
            break;
        case HAL_GPIO_1:
            ret = msp430fr69cc_gpio_p1_1_lock_pin_map_to_gpio_1();
            if (ret != HAL_SUCCESS) {
                goto finish;
            }
            break;
